...
FormOutputLayerNew::FormOutputLayerNew(){
    ...
    connect(this->_threadWidgetRowOperation,SIGNAL(signalWidgetScrollAreaSetHeight(const ThreadWidgetRowOperation::OperationType&)),this,SLOT(slotWidgetScrollAreaSetHeight(const ThreadWidgetRowOperation::OperationType&)));
...
void FormOutputLayerNew::slotWidgetScrollAreaSetHeight(const ThreadWidgetRowOperation::OperationType& operationType){
