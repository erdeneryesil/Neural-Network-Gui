...
void FormMain::slotPushButtonTrainClicked(){
    ...
    if(FormMain::NeuralNetworkObject()->getActionMode()==NeuralNetwork::ActionMode::Train){
        ...
        this->_errorValues->clear();//eğitimin durdurulduğu her yerde bu konteyner temizlenmeli
        this->_updatedWeights->clear();//eğitimin durdurulduğu her yerde bu konteyner temizlenmeli
        this->_countEW=0;//eğitimin durdurulduğu her yerde bu değişken sıfırlanmalı
        this->_countSample=0;//eğitimin durdurulduğu her yerde bu değişken sıfırlanmalı
    }else{
